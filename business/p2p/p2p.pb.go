...
func (*P2PMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_p2p_b742b7317c2865c2, []int{0}
}
...
func (*P2PInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_p2p_b742b7317c2865c2, []int{1}
}
...
func (*P2PConfirmMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_p2p_b742b7317c2865c2, []int{2}
}
...
func (*WaitConfirmMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_p2p_b742b7317c2865c2, []int{3}
}
...
func (*P2PConfirmInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_p2p_b742b7317c2865c2, []int{4}
}
...
func (*SendedInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_p2p_b742b7317c2865c2, []int{5}
}
...
func (*TxNode) Descriptor() ([]byte, []int) {
	return fileDescriptor_p2p_b742b7317c2865c2, []int{6}
}
...
func init() {
	proto.RegisterFile("github.com/ofgp/ofgp-core/business/p2p/p2p.proto", fileDescriptor_p2p_b742b7317c2865c2)
}

var fileDescriptor_p2p_b742b7317c2865c2 = []byte{
	// 623 bytes of a gzipped FileDescriptorProto
	,
}
